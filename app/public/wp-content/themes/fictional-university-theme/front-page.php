...
{
  echo "<p class='test'>Hi, my name is $name and my favorite color is $color.</p>";
}
...
<?php
$namesArr = array('Brad', 'John', 'Jane', 'Boi');
...
<p>Hi, my name is <?php echo $namesArr[2]; ?>. </p>
...
<div class="page-banner">
  ...
  <div class="page-banner__content container t-center c-white">
    ...
    <a href="<?php echo get_post_type_archive_link('program') ?>" class="btn btn--large btn--blue">Find
      Your Major</a>
  </div>
</div>
  ...
  <div class="hero-slider__slide" style="background-image: url(<?php echo get_theme_file_uri('/images/bus.jpg') ?>);">
    <div class="hero-slider__interior container">
      <div class="hero-slider__overlay">
        ...
        <p class="t-center no-margin"><a href="#" class="btn btn--blue">Learn
            more</a></p>
      </div>
    </div>
  </div>
  ...
  <div class="hero-slider__slide" style="background-image: url(<?php echo get_theme_file_uri('/images/bread.jpg') ?>);">
    <div class="hero-slider__interior container">
      <div class="hero-slider__overlay">
        ...
        <p class="t-center">Fictional University offers lunch plans for those
          in need.</p>
        <p class="t-center no-margin"><a href="#" class="btn btn--blue">Learn
            more</a></p>
      </div>
